...
def parse_command():
    ...
    parser.add_argument('--splits', type=float, nargs='*', required=False, help="Tuple of floats representing the data split")
    parser.add_argument('--pin-memory', action='store_true', default=False, help='whether to use pin memory')
    parser.add_argument('--augment', action='store_true', default=False, help='whether to use data augmentation')
    parser.add_argument('--k-folds', type=int, default=0, help='number of folds for cross validation')
    parser.add_argument('--split', type=str, default='ours', help='split used for the dataset')
    parser.add_argument('--no-validation', action='store_true', default=False, help='whether to use validation set')

    # Network
    parser.add_argument('--network', type=str, default='receptron', help='network used for training')
    ...
    parser.add_argument('--dense', action='store_true', default=False, help='whether to use dense connections')

    # Optimization
    parser.add_argument('--optimizer', type=str, default='adamw', help='optimizer used for training')
    parser.add_argument('--scheduler', type=str, default='cosine', help='scheduler used for training')
